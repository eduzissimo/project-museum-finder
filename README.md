...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/java-0x-projeto-localizador-de-museus/pulls).
...
- Volte até a [página de _Pull  Requests_ do repositório](https://github.com/tryber/java-0x-projeto-localizador-de-museus/pulls) e confira que o seu _Pull Request_ está criado.
